...
public class LoggingHandler extends ChannelDuplexHandler {
    ...
    /**
     * Returns the {@link io.netty.handler.logging.LogLevel} that this handler uses to log
     */
    ...
    /**
     * Returns a String which contains all details to log the {@link io.netty.buffer.ByteBufHolder}.
     *
     * By default this method just delegates to {@link #formatByteBuf(String, io.netty.buffer.ByteBuf)},
     * using the content of the {@link io.netty.buffer.ByteBufHolder}. Sub-classes may override this.
     */
